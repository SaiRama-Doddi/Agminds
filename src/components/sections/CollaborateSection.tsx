...
import { School, Heart, Users, Lightbulb, CheckCircle2, ArrowRight } from 'lucide-react';
  ...
  const partners = [
    {
      icon: School,
      title: 'Schools',
      description: 'Integrate nature-based learning into your curriculum with our concept-driven approach',
      features: ['Curriculum integration support', 'Teacher training programs', 'Resource materials'],
      color: 'from-blue-500 to-cyan-500',
    },
    {
      icon: Heart,
      title: 'NGOs',
      description: 'Collaborate on environmental education initiatives and community programs',
      features: ['Joint program development', 'Community outreach', 'Impact measurement'],
      color: 'from-emerald-500 to-teal-500',
    },
    {
      icon: Users,
      title: 'Educators',
      description: 'Join a community of facilitators bringing nature education to children',
      features: ['Professional development', 'Resource sharing', 'Mentorship programs'],
      color: 'from-purple-500 to-pink-500',
    },
    {
      icon: Lightbulb,
      title: 'Pilot Programs',
      description: 'Test new approaches and contribute to shaping the future of nature education',
      features: ['Early access to content', 'Feedback opportunities', 'Co-creation sessions'],
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          {partners.map((partner, index) => (
            <motion.div
              ...
              className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-teal-200 hover:-translate-y-2"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-teal-100/30 to-transparent rounded-full blur-2xl group-hover:scale-150 transition-transform duration-500"></div>
          ...
          <div className="inline-block bg-[#664343] rounded-2xl p-12 text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100 text-lg mb-8 max-w-2xl">
                Whether you're an educator, institution, or organization, we'd love to explore how we can work together.
              </p>
              <a
                href="/contact"
