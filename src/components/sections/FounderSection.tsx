...
const FounderSection = () => {
  ...
  const principles = [
    {
      ...
      description:
        'Care for nature must begin with true understanding, not obligation',
    },
    {
      icon: Target,
      title: 'Depth Over Scale',
      description:
        'Building slowly and thoughtfully for long-term, meaningful impact',
    },
    {
      icon: Compass,
      title: 'Nature as Guide',
      description:
        'Letting natural curiosity and observation lead the learning journey',
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-1/2 h-full bg-gradient-to-r from-emerald-50/30 to-transparent" />
      <div className="absolute bottom-0 right-0 w-1/2 h-full bg-gradient-to-l from-teal-50/30 to-transparent" />
            ...
            <div className="relative z-10 space-y-6 text-lg leading-relaxed text-emerald-50">
              <p>
                <strong className="text-white text-xl">
                  AgMinds began with a simple observation:
                </strong>{' '}
                many children and adults are asked to care about nature without
                ever being given the space to truly understand it.
              </p>
              ...
              <p>
                AgMinds is being built slowly and thoughtfully, shaped by real
                experiences with children, educators, and communities. The goal
                is not scale for its own sake, but{' '}
                <strong className="text-emerald-300">
                  depth, clarity, and long-term impact.
                </strong>
              </p>
